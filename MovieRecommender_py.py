...
Original file is located at
    https://colab.research.google.com/drive/18-mBdzm7xMSUsbLUVOVWYp5Tro72X7ud
"""
...
# To do this, we're going to turn each genre into weights. We can do this by using the input's reviews 
# and multiplying them into the input's genre table and then summing up the resulting table by column. 
